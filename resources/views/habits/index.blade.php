<x-layouts.app>
    <div class="py-6 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
        ...
        <div class="mb-6">
            <a href="{{ route('dashboard') }}" class="inline-flex items-center text-sm font-medium text-indigo-600 hover:text-indigo-900 transition-colors">
        ...
        <div class="bg-white p-6 rounded-xl shadow-md border border-gray-100 mb-8">
            ...
            <form action="{{ route('habits.store') }}" method="POST" class="space-y-4">
                ...
                <button type="submit" class="w-full bg-indigo-600 text-white py-2.5 rounded-lg font-bold hover:bg-indigo-700 transition-colors shadow-sm">Simpan Habit</button>
            </form>
        </div>
